...
(function () {
    ...
    FTable.prototype._fixTable = function(_){
    ...
    FTable.prototype.buildHead = function(){
        var _ = this;
        ...
        var sw = _.obj.offsetHeight > _.box.offsetHeight ? 4 : 0;
    ...
    FTable.prototype.buildLeft = function(){
        var _ = this;
        if(_.config.cols <= 0){
            return false;
        }
        ...
        var sw = _.obj.offsetWidth > _.box.offsetWidth ? 12 : 0;
    ...
    FTable.prototype.buildTopLeft = function(){
        var _ = this;
